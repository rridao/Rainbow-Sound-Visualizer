...
//        if( !g_usedb ) {
        specCalc = g_gain * g_freq_scale * 1.8f * ::pow( 25 * cmp_abs( cbuf[i] ), .5 ) + y;
//        if(i%100 == 0) {
//            fprintf (stderr, "%f ", specCalc);
//        }
        if(specCalc > cutoff) {
            g_spectrums[g_wf][i].y = specCalc;
        } else {
            g_spectrums[g_wf][i].y = cutoff;
        }
//        } else {
